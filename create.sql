...
-- -----------------------------------------------------
-- -----------------------------------------------------
-- Schema template_promod
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema template_promod
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `template_promod` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;

GRANT ALL PRIVILEGES ON template_promod.* TO 'spring'@'%';

USE `template_promod` ;

-- -----------------------------------------------------
-- Table `template_promod`.`bpmnfile`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`bpmnfile` (
...
-- -----------------------------------------------------
-- Table `template_promod`.`user_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`user_type` (
  ...
  CONSTRAINT `FKjiqeajboasuyuv0tmqxp5wr1k`
    ...
    REFERENCES `template_promod`.`user_type` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `template_promod`.`project`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`project` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `template_promod`.`item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`item` (
  ...
  CONSTRAINT `FK9fwhr8epg64uhcgebrnv4fn45`
    FOREIGN KEY (`bpmn_id`)
    REFERENCES `template_promod`.`bpmnfile` (`id`),
  CONSTRAINT `FKa6asmw4mn61f0coj79lia966d`
    FOREIGN KEY (`created_from_id`)
    REFERENCES `template_promod`.`item` (`id`),
  CONSTRAINT `FKf60hnjyqgladtp0jw5o0n4e9u`
    FOREIGN KEY (`project_id`)
    REFERENCES `template_promod`.`project` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `template_promod`.`element_process`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`element_process` (
...
-- -----------------------------------------------------
-- Table `template_promod`.`element_process_usage`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`element_process_usage` (
  `element_id` BIGINT NOT NULL,
  `process_id` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `template_promod`.`group_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`group_user` (
...
-- -----------------------------------------------------
-- Table `template_promod`.`item_user_access`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`item_user_access` (
  `element_id` BIGINT NOT NULL,
  `user_id` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `template_promod`.`item_user_edit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`item_user_edit` (
  `element_id` BIGINT NOT NULL,
  `user_id` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `template_promod`.`process_metric`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`process_metric` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `template_promod`.`project_user_access`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`project_user_access` (
...
-- -----------------------------------------------------
-- Table `template_promod`.`project_user_edit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`project_user_edit` (
  `project_id` BIGINT NOT NULL,
  `user_id` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `template_promod`.`rasci`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`rasci` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `template_promod`.`role_task_usage`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`role_task_usage` (
...
-- -----------------------------------------------------
-- Table `template_promod`.`snapshotbpmn`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`snapshotbpmn` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `bpmn_content` LONGTEXT NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `template_promod`.`snapshot_element`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`snapshot_element` (
  ...
  CONSTRAINT `FK73v8a93k58c9bheo3b2qixqwe`
    ...
    REFERENCES `template_promod`.`snapshotbpmn` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `template_promod`.`snapshot_element_snapshot_process`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`snapshot_element_snapshot_process` (
  ...
  CONSTRAINT `FK59q6obvtj2fpvak21sdnk75j0`
    ...
    REFERENCES `template_promod`.`snapshot_element` (`id`),
...
-- -----------------------------------------------------
-- Table `template_promod`.`snapshot_process_metric`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`snapshot_process_metric` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `description` LONGTEXT NULL DEFAULT NULL,
  `name` VARCHAR(255) NULL DEFAULT NULL,
  `process_id` BIGINT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `template_promod`.`snapshot_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`snapshot_role` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `brief_description` LONGTEXT NULL DEFAULT NULL,
  `change_date` DATE NULL DEFAULT NULL,
  `change_description` LONGTEXT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `template_promod`.`snapshot_rasci`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`snapshot_rasci` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `type` CHAR(1) NOT NULL,
  `role_id` BIGINT NULL DEFAULT NULL,
  `task_id` BIGINT NULL DEFAULT NULL,
  ...
  CONSTRAINT `FKn7klrondnuwrrow0yhj8bx4b4`
    FOREIGN KEY (`role_id`)
    REFERENCES `template_promod`.`snapshot_role` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `template_promod`.`snapshot_work_item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`snapshot_work_item` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `brief_description` LONGTEXT NULL DEFAULT NULL,
  `change_date` DATE NULL DEFAULT NULL,
  `change_description` LONGTEXT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `template_promod`.`snapshot_state`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`snapshot_state` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `FKsyq37e8qugvjogie0eeqqdw3h`
    ...
    REFERENCES `template_promod`.`snapshot_work_item` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `template_promod`.`snapshot_task_step`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`snapshot_task_step` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `description` LONGTEXT NULL DEFAULT NULL,
  `name` VARCHAR(255) NULL DEFAULT NULL,
  `task_id` BIGINT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `template_promod`.`snapshot_work_item_snapshot_task_input`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`snapshot_work_item_snapshot_task_input` (
...
-- -----------------------------------------------------
-- Table `template_promod`.`snapshot_work_item_snapshot_task_output`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`snapshot_work_item_snapshot_task_output` (
  `snapshot_work_item_id` BIGINT NOT NULL,
  `snapshot_element_id` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `template_promod`.`state`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`state` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `state_description` LONGTEXT NULL DEFAULT NULL,
  `state_name` VARCHAR(255) NULL DEFAULT NULL,
  `work_item_id` BIGINT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `template_promod`.`task_step`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`task_step` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `description` LONGTEXT NULL DEFAULT NULL,
  `name` VARCHAR(255) NULL DEFAULT NULL,
  `task_id` BIGINT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `template_promod`.`work_item_activity_guidance`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`work_item_activity_guidance` (
...
-- -----------------------------------------------------
-- Table `template_promod`.`work_item_process_usage`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`work_item_process_usage` (
  `work_item_id` BIGINT NOT NULL,
  `process_id` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `template_promod`.`work_item_task_mandatory_input`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`work_item_task_mandatory_input` (
  `work_item_id` BIGINT NOT NULL,
  `element_id` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `template_promod`.`work_item_task_output`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`work_item_task_output` (
  `work_item_id` BIGINT NOT NULL,
  `element_id` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `template_promod`.`work_item_task_usage`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `template_promod`.`work_item_task_usage` (
  `work_item_id` BIGINT NOT NULL,
  `task_id` BIGINT NOT NULL,
